...
bounds = [[0,2,1],[1,2,1],[2,2,1],[2,2,2],[1,0,2],[3,3,1],[3,5,2]]
board = make_board(6, bounds)

root = Node(p0_pos)

########### GET CHILDREN TEST################
root = get_children(board, p1_pos, p0_pos, 3, -1, root)

for c in root.children:
    print("=====" + str(c.pos)+ ' '+ str(c.boundary))
    assert(c.level==1)
